...
class Emogrifier
{
     ...
     */
    public function handleXpathQueryWarnings($type, $message, $file, $line, array $context) // @codingStandardsIgnoreLine
    {
        ...
        // Catches eventual warnings generated by invalid selectors in method getNodesToExclude()
        if (isset($context['selectorToExclude'])) {
            throw new \InvalidArgumentException(
                sprintf(
                    '%1$s in selector >> %2$s << in %3$s on line %4$u',
                    $message,
